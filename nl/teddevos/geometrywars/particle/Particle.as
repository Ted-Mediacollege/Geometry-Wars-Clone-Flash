...
package nl.teddevos.geometrywars.particle
{
     ...
     *  @see Image
     */
    public class Particle extends DisplayObject
    {
        private var mTinted:Boolean;
        
        /** The raw vertex data of the quad. */
        protected var mVertexData:ParticleVertex;
        ...
        public function Particle(width:Number, height:Number, color:uint=0xffffff, premultipliedAlpha:Boolean=true)
        {
            ...
            mVertexData = new ParticleVertex(4, premultipliedAlpha);
        ...
        public function copyVertexDataTo(targetData:ParticleVertex, targetVertexID:int=0):void
        {
        ...
        public function copyVertexDataTransformedTo(targetData:ParticleVertex, targetVertexID:int=0, matrix:Matrix=null, vx:Number = 1, vy:Number = 0, age:Number = 100):void
        {
            mVertexData.copyTransformedTo(targetData, targetVertexID, matrix, 0, 4, vx, vy, age);
        }
