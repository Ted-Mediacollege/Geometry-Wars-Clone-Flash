...
package nl.teddevos.geometrywars.background
{
    ...
    public class Star extends DisplayObject
    {
        ...
        protected var mVertexData:StarVertex;
        ...
        public function Star(width:Number, height:Number, color:uint=0xffffff, premultipliedAlpha:Boolean=true)
        {
            ...
            mVertexData = new StarVertex(4, premultipliedAlpha);
        ...
        public function copyVertexDataTo(targetData:StarVertex, targetVertexID:int=0):void
        {
        ...
        public function copyVertexDataTransformedTo(targetData:StarVertex, targetVertexID:int=0, matrix:Matrix=null, depth:Number = 1):void
        {
            mVertexData.copyTransformedTo(targetData, targetVertexID, matrix, 0, 4, depth);
        }
